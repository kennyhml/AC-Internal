...
/**
 * @brief Calls assault cubes kill functionality to kill the
 * given entity without conditions, not tested online.
 *
 ...
 *
 * void __usercall kill(int weaponID@<eax>, Player *entity@<ecx>, int dmgSource, char a4)
 *
 * Still dont know what char a4 does, I just pass a questionmark for it and it doesnt really seem to matter as long
 * as its any character.
 *
 * So first we move 5 into eax which is the sniper weapon ID, then '?' into edx which is our unknown char, we have to push edx
